...
document.querySelector(".close_btn").onclick = modalToggle;
...
function displayMarker() {
  ...
  for (var i = 0; i < positions.length; i++) {
    ...
    var infowindow = new kakao.maps.InfoWindow({
      content: `<img style="width:100%; height:50px;" src=${positions[i].img}><br /><div> ${positions[i].title}</div><div style="padding:5px;">${positions[i].addr1}</div><br /><div>`, // 인포윈도우에 표시할 내용
    });
